...
class AuthController {
     ...
     * @param {LogInAuthoriseRequest} body TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createLogInAuthorise(contentType, body, callback) {
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    const mappedObject = _baseController.getObjectMapper().mapObject(response, 'FailureException');
     ...
     * @returns {Promise}
     */
    static createVerify(contentType, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        return new Promise((_fulfill, _reject) => {
            _request(_options, (_error, _response, _context) => {
                ...
                if (_error) {
                    ...
                    let parsed = JSON.parse(_response.body);
                    parsed = _baseController.getObjectMapper().mapObject(parsed, 'Verification');
                    _callback(null, parsed, _context);
                    _fulfill(parsed);
                } else {
                    errorResponse = _baseController.validateResponse(_context);
